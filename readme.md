...
| Title        | Purpose                                                                       | Link          |
| ------------ | ----------------------------------------------------------------------------- | ------------- |
| W3Schools | Helped with some basic refreshers of HTML, CSS, and JavaScript | w3schools.com |
| ChatGPT | Helped with underlying errors, and improved some technical issues. | chatgpt.com |
